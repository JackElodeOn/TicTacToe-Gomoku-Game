...
GomokuGame::GomokuGame() : GameBoard(20, 20, 1, 1, 19, 19, 5, 1, true) {
    game_piece::player_one_type = "B";
    game_piece::player_two_type = "W";
}

GomokuGame::GomokuGame(unsigned int width_) : GameBoard(width_ + 1, width_ + 1, 1, 1, width_, width_, width_, 1, true)
{
    if (width_ >= 5) {
        set_win_num(5);
    }
...
GomokuGame::GomokuGame(unsigned int width_, unsigned int win_num_) : GameBoard(width_ + 1, width_ + 1, 1, 1, width_, width_, win_num_, 1, true) {
    game_piece::player_one_type = "B";
    game_piece::player_two_type = "W";
}
